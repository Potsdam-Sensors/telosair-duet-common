...
/* ~~ MK4 Var 1 (SPS30s instead of PT) ~~ */
var DuetTypeMk4Var1 = DuetTypeInfo{
	ExpectedBytes:        70,
	ExpectedStringLen:    15,
	StructInstanceGetter: func() DuetData { return &DuetDataMk4Var1{} },
	TypeAlias:            "Mk4.1",
}

type DuetDataMk4Var1 struct {
	SerialNumber   uint16
	SampleTimeMs   uint32
	UnixSec        uint32
...
func (d *DuetDataMk4Var1) TimeResolved() bool {
	return d.timeResolved
}
func (d *DuetDataMk4Var1) MarkTimeResolved(v bool) {
	d.timeResolved = v
}
func (d *DuetDataMk4Var1) Timestamp() uint32 {
	return d.UnixSec
}
func (d *DuetDataMk4Var1) ResolveTime(t uint32) {
	d.UnixSec = t
}

func (d *DuetDataMk4Var1) SensorMeasurements() []SensorMeasurement {
	return []SensorMeasurement{d.SpsM, d.TempRh, d.Scd, d.Mprls, d.Sgp, DuetSensorState{d.SensorStates}}
}
...
func (d *DuetDataMk4Var1) String() string {
	return fmt.Sprintf("[Duet %d, Type 4.1 | Unix %d | %s | HTU: %s | SCD: %s | MPRLS: %s | SGP: %s | PT1: %s | PT2: %s | PTM: %s | Radio: %s | Errstate %d | PoE Voltage %d]",
		d.SerialNumber, d.UnixSec, d.TempRh.String(), d.Htu.String(), d.Scd.String(), d.Mprls.String(), d.Sgp.String(), d.Sps1.String(), d.Sps2.String(), d.SpsM.String(),
		d.RadioMeta.String(), d.SensorStates, d.PoeUsbVoltage)
}
func (d *DuetDataMk4Var1) GetTypeInfo() DuetTypeInfo {
	return DuetTypeMk4Var1
}

func (d *DuetDataMk4Var1) SetConnectionType(ct int) {
	d.ConnectionType = ct
}
func (d *DuetDataMk4Var1) SetTimeRadio(unixSecRecieved uint32) error {
...
func (d *DuetDataMk4Var1) SetTimeSerial(unixSecRecieved uint32) {
	d.UnixSec = unixSecRecieved
}

func (d *DuetDataMk4Var1) RecalculateLastResetUnix() {
	d.LastResetUnix = d.UnixSec - (d.SampleTimeMs / 1000)
}

func (d *DuetDataMk4Var1) doPopulateFromSubStrings(splitStr []string) error {
	// Serial Number
	...
	MergePT(&d.Sps1, &d.Sps2, &d.SpsM)
	CombineTempRhMeasurements(d.Htu, d.Scd, &d.TempRh)

	return nil
}
func (d *DuetDataMk4Var1) doPopulateFromBytes(buff []byte) error {
	...
	if err := d.Sps1.PopulateFromBytes(buff[34:52]); err != nil {
		return fmt.Errorf("error parsing bytes for PT: %w", err)
	}
	if err := d.Sps2.PopulateFromBytes(buff[52:70]); err != nil {
		return fmt.Errorf("error parsing bytes for PT: %w", err)
	}
	MergePT(&d.Sps1, &d.Sps2, &d.SpsM)
	CombineTempRhMeasurements(d.Htu, d.Scd, &d.TempRh)
...
func (d *DuetDataMk4Var1) ToMap(gatewaySerial string) map[string]any {
	ret := map[string]any{
		KEY_DEVICE_TYPE:     4.1,
