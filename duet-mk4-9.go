...
/* ~~ MK4 Var 9 (Indoor, 1 SPS30, CO, NO2, CH4, + Cell Hat) ~~ */
var DuetTypeMk4Var9 = DuetTypeInfo{
	ExpectedBytes:        90,
	ExpectedStringLen:    16,
	StructInstanceGetter: func() DuetData { return &DuetDataMk4Var9{} },
	TypeAlias:            "Mk4.9",
}

type DuetDataMk4Var9 struct {
	SerialNumber   uint16
	SampleTimeMs   uint32
	UnixSec        uint32
...
func (d *DuetDataMk4Var9) TimeResolved() bool {
	return d.timeResolved
}
func (d *DuetDataMk4Var9) MarkTimeResolved(v bool) {
	d.timeResolved = v
}
func (d *DuetDataMk4Var9) Timestamp() uint32 {
	return d.UnixSec
}
func (d *DuetDataMk4Var9) ResolveTime(t uint32) {
	d.UnixSec = t
}

func (d *DuetDataMk4Var9) SensorMeasurements() []SensorMeasurement {
	return []SensorMeasurement{d.Sps, d.TempRh, d.Scd, d.Mprls, d.Sgp, &d.Gas, DuetSensorState{d.SensorStates}}
}
func (d *DuetDataMk4Var9) SetRadioData(v RadioMetadata) {
	d.RadioMeta = v
}
func (d *DuetDataMk4Var9) SetPiMcuTemp(val float32) {
	d.PiMcuTemp = val
	d.piMcuTempSet = true
}
func (d *DuetDataMk4Var9) String() string {
	return fmt.Sprintf("[Duet %d, Type 4.9 | Unix %d | Co %.2f, O3: %.2f | %s | HTU: %s | SCD: %s | MPRLS: %s | SGP: %s | SPS30 (as PMS5003): [%s] | Radio: %s | Errstate %d | PoE Voltage %d]",
...
func (d *DuetDataMk4Var9) GetTypeInfo() DuetTypeInfo {
	return DuetTypeMk4Var9
}

func (d *DuetDataMk4Var9) SetConnectionType(ct int) {
	d.ConnectionType = ct
}
func (d *DuetDataMk4Var9) SetTimeRadio(unixSecRecieved uint32) error {
...
func (d *DuetDataMk4Var9) SetTimeSerial(unixSecRecieved uint32) {
	d.UnixSec = unixSecRecieved
}

func (d *DuetDataMk4Var9) RecalculateLastResetUnix() {
	d.LastResetUnix = d.UnixSec - (d.SampleTimeMs / 1000)
}

func (d *DuetDataMk4Var9) doPopulateFromSubStrings(splitStr []string) error {
	// Serial Number
...
func (d *DuetDataMk4Var9) doPopulateFromBytes(buff []byte) error {
...
func (d *DuetDataMk4Var9) ToMap(gatewaySerial string) map[string]any {
	ret := map[string]any{
		KEY_DEVICE_TYPE:     4.9,
