...
/* ~~ MK4 Var 17 - One SPS30 ~~ */
var DuetTypeMk4Var17 = DuetTypeInfo{
	ExpectedBytes:        52,
	ExpectedStringLen:    14,
	StructInstanceGetter: func() DuetData { return &DuetDataMk4Var17{} },
	TypeAlias:            "Mk4.17",
}

type DuetDataMk4Var17 struct {
	SerialNumber   uint16
	SampleTimeMs   uint32
	UnixSec        uint32
...
func (d *DuetDataMk4Var17) TimeResolved() bool {
	return d.timeResolved
}
func (d *DuetDataMk4Var17) MarkTimeResolved(v bool) {
	d.timeResolved = v
}
func (d *DuetDataMk4Var17) Timestamp() uint32 {
	return d.UnixSec
}
func (d *DuetDataMk4Var17) ResolveTime(t uint32) {
	d.UnixSec = t
}

func (d *DuetDataMk4Var17) SensorMeasurements() []SensorMeasurement {
	return []SensorMeasurement{d.Sps, d.TempRh, d.Scd, d.Mprls, d.Sgp, DuetSensorState{d.SensorStates}}
}
func (d *DuetDataMk4Var17) SetRadioData(v RadioMetadata) {
	d.RadioMeta = v
}
func (d *DuetDataMk4Var17) SetPiMcuTemp(val float32) {
	d.PiMcuTemp = val
	d.piMcuTempSet = true
}
func (d *DuetDataMk4Var17) String() string {
	return fmt.Sprintf("[Duet %d, Type 4.17 | Unix %d | %s | HTU: %s | SCD: %s | MPRLS: %s | SGP: %s | SPS: %s | Radio: %s | Errstate %d | PoE Voltage %d]",
...
func (d *DuetDataMk4Var17) GetTypeInfo() DuetTypeInfo {
	return DuetTypeMk4Var17
}

func (d *DuetDataMk4Var17) SetConnectionType(ct int) {
	d.ConnectionType = ct
}
func (d *DuetDataMk4Var17) SetTimeRadio(unixSecRecieved uint32) error {
...
func (d *DuetDataMk4Var17) SetTimeSerial(unixSecRecieved uint32) {
	d.UnixSec = unixSecRecieved
}

func (d *DuetDataMk4Var17) RecalculateLastResetUnix() {
	d.LastResetUnix = d.UnixSec - (d.SampleTimeMs / 1000)
}

func (d *DuetDataMk4Var17) doPopulateFromSubStrings(splitStr []string) error {
	// Serial Number
...
func (d *DuetDataMk4Var17) doPopulateFromBytes(buff []byte) error {
...
func (d *DuetDataMk4Var17) ToMap(gatewaySerial string) map[string]any {
	ret := map[string]any{
		KEY_DEVICE_TYPE:     4.17,
