...
func TestDuetsImplementDuetData(t *testing.T) {
	...
	for _, _ = range []DuetData{
		...
		&DuetDataMk4Var22{}, &DuetDataMk4Var23{},
	} {
	}
...
func TestGetTypeInfo(t *testing.T) {
	...
	for varNum, duetTypeInstance := range []*DuetTypeInfo{
		...
		&DuetTypeMk4Var16, &DuetTypeMk4Var17, &DuetTypeMk4Var18, &DuetTypeMk4Var19, &DuetTypeMk4Var21, &DuetDataMk4Var22,
		&DuetDataMk4Var23,
	} {
...
func TestDuetTypeMethods(t *testing.T) {
	...
	for _, testData := range []testData{
		...
		{&DuetTypeMk4Var13, "Mk4.13", &DuetDataMk4Var13{}},
		{&DuetTypeMk4Var14, "Mk4.14", &DuetDataMk4Var14{}},
		{&DuetTypeMk4Var15, "Mk4.15", &DuetDataMk4Var15{}},
		{&DuetTypeMk4Var16, "Mk4.16", &DuetDataMk4Var16{}},
		...
		{&DuetTypeMk4Var21, "Mk4.22", &DuetDataMk4Var22{}},
		{&DuetTypeMk4Var21, "Mk4.23", &DuetDataMk4Var23{}},
	} {
...
func TestDuetMethodsSimple(t *testing.T) {
	...
	for _, testData := range []TestData{
		...
		{&DuetDataMk4Var7{}, 4.7},
		{&DuetDataMk4Var8{}, 4.8},
		{&DuetDataMk4Var13{}, 4.13},
		{&DuetDataMk4Var14{}, 4.14},
		{&DuetDataMk4Var15{}, 4.15},
		{&DuetDataMk4Var16{}, 4.16},
		{&DuetDataMk4Var17{}, 4.17},
		{&DuetDataMk4Var18{}, 4.18},
		{&DuetDataMk4Var19{}, 4.19},
		{&DuetDataMk4Var19{}, 4.21},
		{&DuetDataMk4Var19{}, 4.22},
		{&DuetDataMk4Var19{}, 4.23},
	} {
		...
		if duetTypeFloat != expectedType {
			t.Errorf("duet type was expected to be %.2f, got %.2f instead: %v", expectedType, duetTypeFloat, duetDataMap)
		}
	}
}
