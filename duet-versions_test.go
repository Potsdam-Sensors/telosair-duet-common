...
func TestDuetsImplementDuetData(t *testing.T) {
	...
	for _, _ = range []DuetData{
		&DuetDataMk1Var0{}, &DuetDataMk1Var2{}, &DuetDataMk1Var3{}, &DuetDataMk1Var5{},
		&DuetDataMk3Var1{},
...
func TestGetTypeInfo(t *testing.T) {
	...
	for varNum, duetTypeInstance := range []*DuetTypeInfo{
		...
		nil, &DuetTypeMk4Var21, &DuetTypeMk4Var22,
	...
	/* MK1 */
	for varNum, duetTypeInstance := range []*DuetTypeInfo{
		&DuetTypeMk1Var0, nil, &DuetTypeMk1Var2, &DuetTypeMk1Var3, nil, &DuetTypeMk1Var5,
	} {
...
func TestDuetTypeMethods(t *testing.T) {
	...
	for _, testData := range []testData{
		...
		{&DuetTypeMk1Var5, "Mk1.5", &DuetDataMk1Var5{}},
		...
		{&DuetTypeMk4Var26, "Mk4.26", &DuetDataMk4Var26{}},
	} {
