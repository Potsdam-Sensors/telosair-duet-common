...
/* ~~ MK4 Var21 ~~ */
var DuetTypeMk4Var21 = DuetTypeInfo{
	ExpectedBytes:        82,
	ExpectedStringLen:    21,
	StructInstanceGetter: func() DuetData { return &DuetDataMk4Var21{} },
	TypeAlias:            "Mk4.21",
}

type DuetDataMk4Var21 struct {
	SerialNumber   uint16
	SampleTimeMs   uint32
	UnixSec        uint32
...
func (d *DuetDataMk4Var21) TimeResolved() bool {
	return d.timeResolved
}
func (d *DuetDataMk4Var21) MarkTimeResolved(v bool) {
	d.timeResolved = v
}
func (d *DuetDataMk4Var21) Timestamp() uint32 {
	return d.UnixSec
}
func (d *DuetDataMk4Var21) ResolveTime(t uint32) {
	d.UnixSec = t
}

func (d *DuetDataMk4Var21) SensorMeasurements() []SensorMeasurement {
	return []SensorMeasurement{d.Sps, d.TempRh, d.Scd, d.Mprls, d.Sgp, DuetSensorState{d.SensorStates}}
} // TODO: See Tgs and gas

func (d *DuetDataMk4Var21) SetRadioData(v RadioMetadata) {
	d.RadioMeta = v
}
func (d *DuetDataMk4Var21) SetPiMcuTemp(val float32) {
	d.PiMcuTemp = val
	d.piMcuTempSet = true
}
func (d *DuetDataMk4Var21) String() string {
	return fmt.Sprintf("[Duet %d, Type 4.21 | Unix %d | Co %.3f, No: %.3f, No2: %.3f, Ch2o: %.3f, H2s: %.3f | TGS2611 Rs: %.1f, %.1f | %s | HTU: %s | SCD: %s | MPRLS: %s | SGP: %s | SPS30: %s | Radio: %s | Errstate %d | PoE Voltage %d]",
		d.SerialNumber, d.UnixSec, d.Co, d.No, d.No2, d.Ch2o, d.H2s, d.TGS2611_Rs1, d.TGS2611_Rs2, d.TempRh.String(), d.Htu.String(), d.Scd.String(), d.Mprls.String(), d.Sgp.String(), d.Sps.String(),
		d.RadioMeta.String(), d.SensorStates, d.PoeUsbVoltage)
}
func (d *DuetDataMk4Var21) GetTypeInfo() DuetTypeInfo {
	return DuetTypeMk4Var21
}

func (d *DuetDataMk4Var21) SetConnectionType(ct int) {
	d.ConnectionType = ct
}
func (d *DuetDataMk4Var21) SetTimeRadio(unixSecRecieved uint32) error {
...
func (d *DuetDataMk4Var21) SetTimeSerial(unixSecRecieved uint32) {
	d.UnixSec = unixSecRecieved
}

func (d *DuetDataMk4Var21) RecalculateLastResetUnix() {
...
func (d *DuetDataMk4Var21) doPopulateFromSubStrings(splitStr []string) error {
	idx := 0
	...
	// TGS2611
	if tgs_rs1, err := strconv.ParseFloat(splitStr[idx], 32); err != nil {
	...
	if tgs_rs2, err := strconv.ParseFloat(splitStr[idx], 32); err != nil {
...
func (d *DuetDataMk4Var21) doPopulateFromBytes(buff []byte) error {
	idx := 0
	...
	if err := binary.Read(reader, binary.LittleEndian, &d.TGS2611_Rs1); err != nil {
		return fmt.Errorf("error converting bytes to float: %w", err)
	}
	if err := binary.Read(reader, binary.LittleEndian, &d.TGS2611_Rs2); err != nil {
		return fmt.Errorf("error converting bytes to float: %w", err)
	}
	idx += (12 * 4)
...
func (d *DuetDataMk4Var21) ToMap(gatewaySerial string) map[string]any {
	ret := map[string]any{
		KEY_DEVICE_TYPE:     4.21,
