...
func (d *DuetDataMk4Var18) TimeResolved() bool {
	return d.timeResolved
}
func (d *DuetDataMk4Var18) MarkTimeResolved(v bool) {
	d.timeResolved = v
}
func (d *DuetDataMk4Var18) Timestamp() uint32 {
	return d.UnixSec
}
func (d *DuetDataMk4Var18) ResolveTime(t uint32) {
	d.UnixSec = t
}
...
func (d *DuetDataMk4Var18) SetPiMcuTemp(val float32) {
	d.PiMcuTemp = val
	d.piMcuTempSet = true
}
func (d *DuetDataMk4Var18) String() string {
	return fmt.Sprintf("[Duet %d, Type 4.18 | Unix %d | Co %.2f | %s | HTU: %s | SCD: %s | MPRLS: %s | SGP: %s | SPS30 (as PMS5003): [%s] | Radio: %s | Errstate %d | PoE Voltage %d]",
...
func (d *DuetDataMk4Var18) GetTypeInfo() DuetTypeInfo {
	return DuetTypeMk4Var8
}

func (d *DuetDataMk4Var18) SetConnectionType(ct int) {
	d.ConnectionType = ct
}
func (d *DuetDataMk4Var18) SetTimeRadio(unixSecRecieved uint32) error {
...
func (d *DuetDataMk4Var18) SetTimeSerial(unixSecRecieved uint32) {
	d.UnixSec = unixSecRecieved
}

func (d *DuetDataMk4Var18) RecalculateLastResetUnix() {
	d.LastResetUnix = d.UnixSec - (d.SampleTimeMs / 1000)
}

func (d *DuetDataMk4Var18) doPopulateFromSubStrings(splitStr []string) error {
	// Serial Number
...
func (d *DuetDataMk4Var18) doPopulateFromBytes(buff []byte) error {
...
func (d *DuetDataMk4Var18) ToMap(gatewaySerial string) map[string]any {
	ret := map[string]any{
		KEY_DEVICE_TYPE:     4.18,
