...
func (d *DuetDataMk4Var4) TimeResolved() bool {
	return d.timeResolved
}
func (d *DuetDataMk4Var4) MarkTimeResolved(v bool) {
	d.timeResolved = v
}
func (d *DuetDataMk4Var4) Timestamp() uint32 {
	return d.UnixSec
}
func (d *DuetDataMk4Var4) ResolveTime(t uint32) {
	d.UnixSec = t
}
