...
func (d *DuetDataMk4Var3) TimeResolved() bool {
	return d.timeResolved
}
func (d *DuetDataMk4Var3) MarkTimeResolved(v bool) {
	d.timeResolved = v
}
func (d *DuetDataMk4Var3) Timestamp() uint32 {
	return d.UnixSec
}
func (d *DuetDataMk4Var3) ResolveTime(t uint32) {
	d.UnixSec = t
}
