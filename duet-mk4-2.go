...
/* ~~ MK4 Var 2 (Outdoor, Cell Hat) ~~ */
var DuetTypeMk4Var2 = DuetTypeInfo{
	ExpectedBytes:        70,
	ExpectedStringLen:    15,
	StructInstanceGetter: func() DuetData { return &DuetDataMk4Var2{} },
	TypeAlias:            "Mk4.2",
}

type DuetDataMk4Var2 struct {
	SerialNumber   uint16
	SampleTimeMs   uint32
	UnixSec        uint32
...
func (d *DuetDataMk4Var2) TimeResolved() bool {
	return d.timeResolved
}
func (d *DuetDataMk4Var2) MarkTimeResolved(v bool) {
	d.timeResolved = v
}
func (d *DuetDataMk4Var2) Timestamp() uint32 {
	return d.UnixSec
}
func (d *DuetDataMk4Var2) ResolveTime(t uint32) {
	d.UnixSec = t
}
...
func (d *DuetDataMk4Var2) SetPiMcuTemp(val float32) {
	d.PiMcuTemp = val
	d.piMcuTempSet = true
}
func (d *DuetDataMk4Var2) String() string {
	return fmt.Sprintf("[Duet %d, Type 4.2 | Unix %d | %s | HTU: %s | SCD: %s | MPRLS: %s | SGP: %s | PT1: %s | PT2: %s | PTM: %s | Radio: %s | Errstate %d | PoE Voltage %d]",
		d.SerialNumber, d.UnixSec, d.TempRh.String(), d.Htu.String(), d.Scd.String(), d.Mprls.String(), d.Sgp.String(), d.Pt1.String(), d.Pt2.String(), d.PtM.String(),
		d.RadioMeta.String(), d.SensorStates, d.PoeUsbVoltage)
}
func (d *DuetDataMk4Var2) GetTypeInfo() DuetTypeInfo {
	return DuetTypeMk4Var2
}

func (d *DuetDataMk4Var2) SetConnectionType(ct int) {
	d.ConnectionType = ct
}
func (d *DuetDataMk4Var2) SetTimeRadio(unixSecRecieved uint32) error {
...
func (d *DuetDataMk4Var2) SetTimeSerial(unixSecRecieved uint32) {
	d.UnixSec = unixSecRecieved
}

func (d *DuetDataMk4Var2) RecalculateLastResetUnix() {
	d.LastResetUnix = d.UnixSec - (d.SampleTimeMs / 1000)
}

func (d *DuetDataMk4Var2) doPopulateFromSubStrings(splitStr []string) error {
	// Serial Number
...
func (d *DuetDataMk4Var2) doPopulateFromBytes(buff []byte) error {
...
func (d *DuetDataMk4Var2) ToMap(gatewaySerial string) map[string]any {
	ret := map[string]any{
		KEY_DEVICE_TYPE:     4.2,
