...
/* ~~ MK4 Var 23 -- based off 10 (Indoor, 1 SPS30, CO, NO2) - TGS26xx Methane Sensors ~~ */
...
func (d *DuetDataMk4Var23) TimeResolved() bool {
	return d.timeResolved
}
func (d *DuetDataMk4Var23) MarkTimeResolved(v bool) {
	d.timeResolved = v
}
func (d *DuetDataMk4Var23) Timestamp() uint32 {
	return d.UnixSec
}
func (d *DuetDataMk4Var23) ResolveTime(t uint32) {
	d.UnixSec = t
}

func (d *DuetDataMk4Var23) SensorMeasurements() []SensorMeasurement {
	return []SensorMeasurement{d.Sps, d.TempRh, d.Scd, d.Mprls, d.Sgp, &d.Gas, DuetSensorState{d.SensorStates}} // TODO add TGS
}
func (d *DuetDataMk4Var23) SetRadioData(v RadioMetadata) {
	d.RadioMeta = v
}
func (d *DuetDataMk4Var23) SetPiMcuTemp(val float32) {
	d.PiMcuTemp = val
	d.piMcuTempSet = true
}
func (d *DuetDataMk4Var23) String() string {
	return fmt.Sprintf("[Duet %d, Type 4.23 | Unix %d | Co %.2f, NO2: %.2f | TGS %.3f & %.3f | %s | HTU: %s | SCD: %s | MPRLS: %s | SGP: %s | SPS30 (as PMS5003): [%s] | Radio: %s | Errstate %d | PoE Voltage %d]",
		d.SerialNumber, d.UnixSec, d.Co, d.No2, d.TGS2611_Rs1, d.TGS2611_Rs2, d.TempRh.String(), d.Htu.String(), d.Scd.String(), d.Mprls.String(), d.Sgp.String(), d.Sps.String(),
		d.RadioMeta.String(), d.SensorStates, d.PoeUsbVoltage)
}
func (d *DuetDataMk4Var23) GetTypeInfo() DuetTypeInfo {
	return DuetTypeMk4Var23
}

func (d *DuetDataMk4Var23) SetConnectionType(ct int) {
	d.ConnectionType = ct
}
func (d *DuetDataMk4Var23) SetTimeRadio(unixSecRecieved uint32) error {
...
func (d *DuetDataMk4Var23) SetTimeSerial(unixSecRecieved uint32) {
	d.UnixSec = unixSecRecieved
}

func (d *DuetDataMk4Var23) RecalculateLastResetUnix() {
	d.LastResetUnix = d.UnixSec - (d.SampleTimeMs / 1000)
}

func (d *DuetDataMk4Var23) doPopulateFromSubStrings(splitStr []string) error {
	// Serial Number
	...
	if tgs_rs1, err := strconv.ParseFloat(splitStr[14], 32); err != nil {
		return fmt.Errorf("failed to convert tgs2611_rs string, %s, to float32", splitStr[5])
	} else {
		d.TGS2611_Rs1 = float32(tgs_rs1)
	}
	if tgs_rs2, err := strconv.ParseFloat(splitStr[15], 32); err != nil {
...
func (d *DuetDataMk4Var23) doPopulateFromBytes(buff []byte) error {
...
func (d *DuetDataMk4Var23) ToMap(gatewaySerial string) map[string]any {
	ret := map[string]any{
		KEY_DEVICE_TYPE:     4.23,
