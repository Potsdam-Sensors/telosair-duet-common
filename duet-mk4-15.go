...
/* ~~ MK4 Var 15 (Outdoor, 1 PT, 1 SPS, CO, O3, NO2) ~~ */
var DuetTypeMk4Var15 = DuetTypeInfo{
	ExpectedBytes:        108,
	ExpectedStringLen:    17,
	StructInstanceGetter: func() DuetData { return &DuetDataMk4Var15{} },
	TypeAlias:            "Mk4.15",
}

type DuetDataMk4Var15 struct {
	SerialNumber   uint16
	SampleTimeMs   uint32
	UnixSec        uint32
...
func (d *DuetDataMk4Var15) SensorMeasurements() []SensorMeasurement {
	return []SensorMeasurement{d.PtM, d.TempRh, d.Scd, d.Mprls, d.Sgp, &d.Gas, DuetSensorState{d.SensorStates}}
}
func (d *DuetDataMk4Var15) SetRadioData(v RadioMetadata) {
	d.RadioMeta = v
}
func (d *DuetDataMk4Var15) SetPiMcuTemp(val float32) {
	d.PiMcuTemp = val
	d.piMcuTempSet = true
}
func (d *DuetDataMk4Var15) String() string {
	return fmt.Sprintf("[Duet %d, Type 4.15 | Unix %d | Co %.2f, O3: %.2f, CH4: %.2f | %s | HTU: %s | SCD: %s | MPRLS: %s | SGP: %s | PTs: 1[%s], 2[%s|, M[%s] | Radio: %s | Errstate %d | PoE Voltage %d]",
...
func (d *DuetDataMk4Var15) GetTypeInfo() DuetTypeInfo {
	return DuetTypeMk4Var15
}

func (d *DuetDataMk4Var15) SetConnectionType(ct int) {
	d.ConnectionType = ct
}
func (d *DuetDataMk4Var15) SetTimeRadio(unixSecRecieved uint32) error {
...
func (d *DuetDataMk4Var15) SetTimeSerial(unixSecRecieved uint32) {
	d.UnixSec = unixSecRecieved
}

func (d *DuetDataMk4Var15) RecalculateLastResetUnix() {
	d.LastResetUnix = d.UnixSec - (d.SampleTimeMs / 1000)
}

func (d *DuetDataMk4Var15) doPopulateFromSubStrings(splitStr []string) error {
	// Serial Number
...
func (d *DuetDataMk4Var15) doPopulateFromBytes(buff []byte) error {
...
func (d *DuetDataMk4Var15) ToMap(gatewaySerial string) map[string]any {
	ret := map[string]any{
		KEY_DEVICE_TYPE:     4.15,
