...
/* ~~ MK4 Var 7 - One SPS30 ~~ */
var DuetTypeMk4Var19 = DuetTypeInfo{
	ExpectedBytes:        78,
	ExpectedStringLen:    16,
	StructInstanceGetter: func() DuetData { return &DuetDataMk4Var19{} },
	TypeAlias:            "Mk4.19",
}

type DuetDataMk4Var19 struct {
	SerialNumber   uint16
	SampleTimeMs   uint32
	UnixSec        uint32
...
func (d *DuetDataMk4Var19) TimeResolved() bool {
	return d.timeResolved
}
func (d *DuetDataMk4Var19) MarkTimeResolved(v bool) {
	d.timeResolved = v
}
func (d *DuetDataMk4Var19) Timestamp() uint32 {
	return d.UnixSec
}
func (d *DuetDataMk4Var19) ResolveTime(t uint32) {
	d.UnixSec = t
}

func (d *DuetDataMk4Var19) SensorMeasurements() []SensorMeasurement {
	return []SensorMeasurement{d.Sps, d.TempRh, d.Scd, d.Mprls, d.Sgp, DuetSensorState{d.SensorStates}}
}
func (d *DuetDataMk4Var19) SetRadioData(v RadioMetadata) {
	d.RadioMeta = v
}
func (d *DuetDataMk4Var19) SetPiMcuTemp(val float32) {
	d.PiMcuTemp = val
	d.piMcuTempSet = true
}

// TODO: why are we hardcoding the type string lol
func (d *DuetDataMk4Var19) String() string {
	return fmt.Sprintf("[Duet %d, Type 4.19 | Unix %d | %s | HTU: %s | SCD: %s | MPRLS: %s | SGP: %s | SPS: %s | TGS2611 Rs: %.1f, %.1f | Radio: %s | Errstate %d | PoE Voltage %d]",
		d.SerialNumber, d.UnixSec, d.TempRh.String(), d.Htu.String(), d.Scd.String(), d.Mprls.String(), d.Sgp.String(), d.Sps.String(),
		d.TGS2611_Rs1, d.TGS2611_Rs2,
		d.RadioMeta.String(), d.SensorStates, d.PoeUsbVoltage)
}
func (d *DuetDataMk4Var19) GetTypeInfo() DuetTypeInfo {
	return DuetTypeMk4Var19
}

func (d *DuetDataMk4Var19) SetConnectionType(ct int) {
	d.ConnectionType = ct
}
func (d *DuetDataMk4Var19) SetTimeRadio(unixSecRecieved uint32) error {
...
func (d *DuetDataMk4Var19) SetTimeSerial(unixSecRecieved uint32) {
	d.UnixSec = unixSecRecieved
}

func (d *DuetDataMk4Var19) RecalculateLastResetUnix() {
	d.LastResetUnix = d.UnixSec - (d.SampleTimeMs / 1000)
}

func (d *DuetDataMk4Var19) doPopulateFromSubStrings(splitStr []string) error {
	// Serial Number
	...
	// TGS2611
	if tgs_rs1, err := strconv.ParseFloat(splitStr[10], 32); err != nil {
		return fmt.Errorf("failed to convert TGS2611 resistance string, %s, to float32", splitStr[10])
	} else {
...
func (d *DuetDataMk4Var19) doPopulateFromBytes(buff []byte) error {
...
func (d *DuetDataMk4Var19) ToMap(gatewaySerial string) map[string]any {
	ret := map[string]any{
		KEY_DEVICE_TYPE:     4.19,
